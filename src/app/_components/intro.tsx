  ...
  return (
    <section className="flex flex-col md:flex-row items-center md:items-start justify-between mt-16 mb-16 md:mb-12 gap-8 md:gap-12">
      <div className="flex flex-col gap-4 flex-1 text-center md:text-left z-10">
        <h1 className="text-5xl md:text-8xl font-bold tracking-tighter leading-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-200 mb-2">
          The DevOrbit.
        </h1>
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-100 max-w-xl leading-relaxed">
